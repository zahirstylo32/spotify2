...
class Queue:
    ...
    def _rebuild_order(self, start_index: int = 0):
        ...
        if self.shuffle:
            ...
            # Poner start_index al frente antes de mezclar el resto
    ...
    def toggle_shuffle(self):
        ...
        start = self._order[self._pos] if self._pos >= 0 else 0
        self._rebuild_order(start)
        # Mantener la canción actual en posición 0 si hay shuffle
        return self.shuffle
